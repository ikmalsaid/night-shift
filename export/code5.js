...
gdjs.HomeCode.asyncCallback20680908 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.HomeCode.asyncCallback20680908(runtimeScene, asyncObjectsList)));
}
}
...
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20680204);
}
}
if (isConditionTrue_0) {
