...
gdjs.Story2Code.asyncCallback19684988 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Story2Code.asyncCallback19684988(runtimeScene, asyncObjectsList)));
}
}
...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19687828);
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(19684284);
}
}
if (isConditionTrue_0) {
